...
- 随机出题，DIY A,B,C,D 选项内容并设置正确选项。
- 替换子比前台投稿发布权限，由本插件接管。
- 设置每道题分类，标题，选项，分数，完全 DIY 的操作。
- 查看历史成绩，可查看上一次考试的分数详情，具体列出每道题加分和扣分。
- 完善的后台管理，设置用户答题状态，设置用户投稿权限，取消考试权限理由反馈。【未上线】
- 后台增加题目，设置每次出题数量，并随机打乱题目排序，防止无脑刷题。【未上线】
- 注册答题，替换子比注册 FROM，注册前需完成答题。【未上线】
- 答题获得邀请码，在原有答题注册上新增答题获取邀请码功能，此功能开启后答题时需要绑定邮箱，一邮箱一码。【未上线】
- 后台查看用户分数，考试状态，考试试卷等。
- 更多功能可提交 issues，插件 100% 开源，禁止用于倒卖！！！
